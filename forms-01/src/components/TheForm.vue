<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control">
      ...
      <!-- v-model converts value of input type number to number data type automatically -->
      <input
        id="age"
        name="age"
        type="number"
...
export default {
  ...
  methods: {
    submitForm() {
      ...
      // Unlike v-model, if you normally get the input value, it will be returned as a string.
...
Lorem ipsum dolor sit amet consectetur adipisicing elit. Quidem saepe modi totam
itaque non? Minima vel cumque perspiciatis doloremque neque tenetur ipsum saepe
fugit. Autem eum iure sunt numquam in.
